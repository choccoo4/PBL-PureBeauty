...
<head>
    ...
    <link
        ...
        rel="stylesheet" />
    <link rel="stylesheet" href="\PBL_OKE\assets\css\profile.css" />
        ...
        <main class="profile-content">
            ...
            <form class="profile-form" action="update_profile.php" method="POST" enctype="multipart/form-data">
                ...
                <input type="tel" id="phone" name="phone"
                    value="<?= htmlspecialchars($user['nomor_telepon'] ?? '', ENT_QUOTES, 'UTF-8'); ?>"
                    pattern="[0-9]+" required>
                <label for="address">Address</label>
                <textarea id="address" name="address" required><?= htmlspecialchars($user['alamat'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
